...
Welcome to **Google TestPerson**, Google's C++ test framework!
...
Getting started information for **Google TestPerson** is available in the
[Google TestPerson Primer](googletest/docs/primer.md) documentation.

**Google Mock** is an extension to Google TestPerson for writing and using C++ mock
...
## Who Is Using Google TestPerson? ##

In addition to many internal projects at Google, Google TestPerson is also used by
...
[Google TestPerson UI](https://github.com/ospector/gtest-gbar) is test runner that runs
your test binary, allows you to track its progress via a progress bar, and
displays a list of test failures. Clicking on one shows failure text. Google
TestPerson UI is written in C#.

[GTest TAP Listener](https://github.com/kinow/gtest-tap-listener) is an event
listener for Google TestPerson that implements the
...
Google TestPerson is designed to have fairly minimal requirements to build
and use with your projects, but there are some.  Currently, we support
Linux, Windows, Mac OS X, and Cygwin.  We will also make our best
effort to support other platforms (e.g. Solaris, AIX, and z/OS).
However, since core members of the Google TestPerson project have no access
to these platforms, Google TestPerson may have outstanding issues there.  If
...
These are the base requirements to build and use Google TestPerson from a source
