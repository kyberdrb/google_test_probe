...
## When using Google Mock, do I have to use Google TestPerson as the testing framework?  I have my favorite testing framework and don't want to switch. ##

Google Mock works out of the box with Google TestPerson.  However, it's easy
