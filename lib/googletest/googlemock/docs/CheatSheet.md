...
The typical flow is:
  ...
  1. Exercise code that uses the mock objects; if necessary, check the result using [Google TestPerson](../../googletest/) assertions.
...
[Google TestPerson](../../googletest/)). They
...
## Matchers as TestPerson Assertions ##
