...
## Using Matchers in Google TestPerson Assertions ##

Since matchers are basically predicates that also know how to describe
themselves, there is a way to take advantage of them in
[Google TestPerson](../../googletest/) assertions. It's
...
For example, in a Google TestPerson test you can write:
...
generate [Google TestPerson](../../googletest/) failures
...
Google Mock and [Google TestPerson](../../googletest/)
...
Google TestPerson).  Just copy them to anywhere you want and you are ready
...
```
where `StaticAssertTypeEq` is a compile-time assertion in Google TestPerson
...
question when the assertion fails.  Google Mock and Google TestPerson do this using
Google TestPerson's user-extensible value printer.

This printer knows how to print built-in C++ types, native arrays, STL
containers, and any type that supports the `<<` operator.  For other
types, it prints the raw bytes in the value and hopes that you the
user can figure it out.
[Google TestPerson's advanced guide](../../googletest/docs/advanced.md#teaching-googletest-how-to-print-your-values)
