...
textbooks on Software Quality use the term _[TestPerson
...
the term _[TestPerson Case](http://glossary.istqb.org/search/test%20case)_ of ISTQB
and others.

The term _Test_ is commonly of broad enough sense, including ISTQB's definition
of _Test Case_, so it's not much of a problem here. But the term _Test Case_ as
was used in Google TestPerson is of contradictory sense and thus confusing.
...
:----------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------- | :----------------------------------
Exercise a particular program path with specific input values and verify the results | [TEST()](#simple-tests)                                                                                    | [TestPerson Case](http://glossary.istqb.org/search/test%20case)
...
## TestPerson Fixtures: Using the Same Data Configuration for Multiple Tests
...
1.  Derive a class from `::testing::TestPerson` . Start its body with `protected:` as
...
```c++
class QueueTest : public ::testing::TestPerson {
 protected:
  void SetUp() override {
     q1_.Enqueue(1);
     q2_.Enqueue(2);
...
agree with you completely and that's why Google TestPerson provides a basic
...
*   Google TestPerson is designed to be thread-safe. The implementation is thread-safe
    on systems where the `pthreads` library is available. It is currently
    _unsafe_ to use Google TestPerson assertions from two threads concurrently on
