...
1.  TestPerson fixtures can be reused via subclassing, which cannot be done easily
...
same fixture class (`::testing::TestPerson`).
...
```c++
namespace foo {
class CoolTest : public ::testing::TestPerson {};  // Fixture foo::CoolTest
...
namespace bar {
class CoolTest : public ::testing::TestPerson {};  // Fixture: bar::CoolTest
TEST_F(CoolTest, DoSomething) {
  SUCCEED();
}
}  // namespace bar
